...
// Tree object
function dTree(objName,treeDir,useCheckbox) {
	...
	this.icon = {
		root				: this.treeDir+'img/base.gif',
		folder			: this.treeDir+'img/folder.gif',
		folderOpen	: this.treeDir+'img/folderopen.gif',
		node				: this.treeDir+'img/page.gif',
		empty				: this.treeDir+'img/empty.gif',
		line				: this.treeDir+'img/line.gif',
		join				: this.treeDir+'img/join.gif',
		joinBottom	: this.treeDir+'img/joinbottom.gif',
		plus				: this.treeDir+'img/plus.gif',
		plusBottom	: this.treeDir+'img/plusbottom.gif',
		minus				: this.treeDir+'img/minus.gif',
		minusBottom	: this.treeDir+'img/minusbottom.gif',
		nlPlus			: this.treeDir+'img/nolines_plus.gif',
		nlMinus			: this.treeDir+'img/nolines_minus.gif'
	};
	this.obj = objName;
	this.aNodes = [];
	this.aIndent = [];
